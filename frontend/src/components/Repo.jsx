    ...
    rounded-full -start-3 ring-8 ring-white'
     ...
     text-gray-400'
			...
			<p className='mb-4 text-base font-normal text-gray-500'>
				{repo.description ? repo.description.slice(0, 500) : "No description provided"} {/* desplay only 500 chars..*/}
			</p>
			{PROGRAMMING_LANGUAGES[repo.language] ? ( // icons downloaded from https://icons8.com/
