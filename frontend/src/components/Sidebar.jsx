...
const Sidebar = () => {
	const { authUser } = useAuthContext(); // https://tailwindcss-glassmorphism.vercel.app/
      ...
      overflow-y-auto border-r bg-glass'
		>
			<nav className='h-full flex flex-col gap-3'>
				...
				>
					<IoHomeSharp size={20} /> {/* from react-icons, select on react icons website */}
				</Link>
